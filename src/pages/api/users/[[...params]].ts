...
import { type User, sampleUserData } from '../../../app/data';
import { CreateUserInput, UpdateUserInput } from '../../../app/dto';
...
class UserRouter {
  ...
  @Delete('/:id')
  @HttpCode(204)
  public deleteUser(@Param('id', ParseNumberPipe) id: number): boolean {
    ...
    // TODO: workaround for Jest (method sould be void)
    return true;
  }
}
